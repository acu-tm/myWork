...
export const CloseCreationWindow = ({ setToggleCreationPage, setToggleUpdatePage }) => (
  <svg
    width='32'
    height='32'
    viewBox='0 0 32 32'
    ...
    onClick={() => {
      if (setToggleCreationPage) setToggleCreationPage(false);
      if (setToggleUpdatePage) setToggleUpdatePage(false);
    }}
  >
    <path
